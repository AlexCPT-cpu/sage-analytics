...
export class univ3factory__parametersResult {
  value0: Address;
  value1: Address;
  value2: Address;
  value3: i32;
...
export class univ3factory extends ethereum.SmartContract {
  static bind(address: Address): univ3factory {
    return new univ3factory("univ3factory", address);
  }
  ...
  parameters(): univ3factory__parametersResult {
    let result = super.call(
      "parameters",
    ...
    return new univ3factory__parametersResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toAddress(),
      result[3].toI32(),
  ...
  try_parameters(): ethereum.CallResult<univ3factory__parametersResult> {
    let result = super.tryCall(
      "parameters",
      "parameters():(address,address,address,uint24,int24)",
      []
    ...
    return ethereum.CallResult.fromValue(
      new univ3factory__parametersResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toAddress(),
        value[3].toI32(),
